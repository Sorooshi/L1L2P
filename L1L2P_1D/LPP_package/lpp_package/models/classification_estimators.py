...
class ClassificationEstimators:
    ...
    def instantiate_tuning_estimator_and_parameters(self, ):
        ...
        # Ensemble learning method(s):
            ...
            # define search space
            self.params = defaultdict()
            self.params["n_estimators"] = Integer(10, 3500, )
        ...
        # Neural Networks method(s):
            ...
            # define search space
            self.params = defaultdict()
            self.params["hidden_layer_sizes"] = (20, 100,)  # 20, 200
            self.params["activation"] = Categorical(["relu"])
            self.params["solver"] = Categorical(["lbfgs", ])  # "sgd", "lbfgs", "adam"
            ...
            self.params["max_iter"] = Integer(100, 1000, "uniform")
